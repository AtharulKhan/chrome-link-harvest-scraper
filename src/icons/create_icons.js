// This script creates placeholder PNG icon files
...
ni27FhEPeXuZC9jp4wPOuU+ttScAPFN2TSI5877oZTZwv98fAXi57DpEcuZ90ct84Pl8aMyLZdcj
...
// Create icon files
saveBase64Image(icon16Base64, path.join(__dirname, "icon16.png"));
saveBase64Image(icon48Base64, path.join(__dirname, "icon48.png"));
saveBase64Image(icon128Base64, path.join(__dirname, "icon128.png"));
